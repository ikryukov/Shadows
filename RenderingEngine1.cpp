...
void RenderingEngine1::OnFingerUp(vec2 location)
{
    m_scale = 1.0f;
}

void RenderingEngine1::OnFingerDown(vec2 location)
{
    m_scale = 1.5f;
    OnFingerMove(location, location);
}

void RenderingEngine1::OnFingerMove(vec2 previous, vec2 location)
{
